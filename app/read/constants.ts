...
export const rareCharPronunciations: Record<string, string> = {
  ...
  '泣': 'qì', '瞋': 'chēn', '嗔': 'chēn', '怖': 'bù', '畏': 'wèi', '劫': 'jié', '垢': 'gòu',
    ...
    '般': 'bō', '若': 'rě', '蕴': 'yùn', '埵': 'duǒ', '谛': 'dì', '婆': 'pó',
    '慢': 'màn', '励': 'lì', '躁': 'zào', '遂': 'suì', '庐': 'lú',
    '徇': 'xùn', '齐': 'qí', '岐': 'qí', '伯': 'bó', '癸': 'guǐ', '嗜': 'shì', '恚': 'huì', '挈': 'qiè',
    '蕃': 'fán', '秀': 'xiù', '坼': 'chè', '亟': 'jí', '飧': 'sūn', '泄': 'xiè', '痿': 'wěi', '厥': 'jué', '痎': 'jiē', '疟': 'nüè',
    '鲲': 'kūn', '徙': 'xǐ', '抟': 'tuán', '蜩': 'tiáo', '枋': 'fāng', '晦': 'huì', '朔': 'shuò', '蟪': 'huì', '蛄': 'gū', '泠': 'líng', '嘘': 'xū', '嗒': 'tà', '籁': 'lài', '噫': 'yī', '宎': 'yǎo', '蘧': 'qú', '殆': 'dài', '庖': 'páo', '踦': 'yǐ', '砉': 'huā', '騞': 'huō', '郤': 'xì', '窾': 'kuǎn', '硎': 'xíng', '怵': 'chù', '謋': 'huò',
    '诲': 'huì', '谆': 'zhūn', '岫': 'xiù'
};
